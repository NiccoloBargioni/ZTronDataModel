...
extension DBMS {
    public static let studio = DomainModel.studio
    public static let game = DomainModel.game
    public static let map = DomainModel.map
    public static let tab = DomainModel.tab
    public static let tool = DomainModel.tool
